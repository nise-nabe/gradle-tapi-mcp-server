...
internal object McpToolDescriptions {
    ...
    const val RUN_TASKS =
        "Run Gradle task paths. Outcome/summary by default; background=true returns buildId for gradle_get_build_status."

    const val RUN_TESTS =
        "Run JVM tests by class, method, or pattern. Provide one of testMethods, testClasses, or includePattern(s). See reference for selection rules."
}
