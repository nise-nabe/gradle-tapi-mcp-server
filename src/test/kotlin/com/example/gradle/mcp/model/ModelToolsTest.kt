...
class ModelToolsTest {
    ...
    @Test
    fun `rejectUnsupportedProjectPath rejects projectPath on gradle_get_help`() {
        val error = shouldThrow<McpException> {
            rejectUnsupportedProjectPath(mapOf("projectPath" to ":plugin"), "gradle_get_help")
        }

        error.code shouldBe McpErrorCode.INVALID_ARGUMENT
        error.message shouldContain "gradle_get_help"
    }
