...
| タグ | 日付（UTC 付近） | 備考 |
|------|------------------|------|
| `v0.2.2` | 2026-06-28 | 最新。アセット `gradle-tapi-mcp-server-0.2.2.jar` |
| `v0.2.1` | 2026-06-28 | |
| `v0.2.0` | 2026-06-28 | |
...
過去の実績では `0.2.0` → `0.2.1` → `0.2.2` とパッチを積み上げている。`main` 上の未リリースコミットを `git log vLATEST..main --oneline` で確認し、変更量に応じて次バージョンを決める。
