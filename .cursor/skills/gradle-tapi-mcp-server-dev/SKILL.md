...
- Plugin manifests: `plugins/gradle-tapi-mcp/plugin.json`, `plugins/gradle-tapi-mcp/.cursor-plugin/plugin.json`, `plugins/gradle-tapi-mcp/.codex-plugin/plugin.json`, `plugins/gradle-tapi-mcp/.devin-plugin/plugin.json`
