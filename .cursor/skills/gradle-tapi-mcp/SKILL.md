...
MCP **resources** (`gradle-tapi://…`) are optional host context wrapping the same connection/environment/overview/build-status handlers. Keep using tools until the client attaches resources; do not skip `tools/call` because templates exist.
